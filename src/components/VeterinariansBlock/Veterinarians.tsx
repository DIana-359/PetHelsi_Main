...
export default function Veterinarians() {
  ...
  return (
    <div id="veterinarians" className="scroll-mt-24 lg:grid grid-cols-12 gap-6 mb-21 lg:mb-14">
      <div className="lg:col-span-5 lg:pt-12">
        <h2 className="uppercase text-2xl leading-[140%] xl:text-[40px] font-semibold text-gray-900 mb-3 xl:mb-12">
          Ветеринари, <br className="hidden lg:inline"/>доступні <br />у найближчий час
        </h2>
        ...
        <Link className="hidden lg:flex items-center gap-4 text-lg font-medium leading-[140%] text-primary-700" href={"/veterinarians"}>
