...
export default function DeletePetModal({
  ...
  const [activeButton, setActiveButton] = useState<"cancel" | "delete">(
    "cancel",
  );
      ...
      <ModalContent className="rounded-[16px] pt-13 pb-8 md:pt-20 md:pb-14 max-w-[560px] ">
        ...
        <div className="flex mt-8 justify-center">
          <div className="flex w-full max-w-[304px] flex-col gap-2">
            <Button
              className={getButtonClasses("primary", activeButton === "cancel")}
              onClick={() => {
                setActiveButton("cancel");
                onClose();
              }}
            ...
            <Button
              className={getButtonClasses("danger", activeButton === "delete")}
              isLoading={isLoading}
              onClick={() => {
