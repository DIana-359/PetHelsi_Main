...
//               value ? "text-gray-900" : "text-gray-350"
...
//                       setBirthMonth(month);
//                       if (birthMonth) {
//                         // Передаємо на сервер повну дату YYYY-MM-DD
//                         const val = month
//                           ? `${birthYear}-${month.padStart(2, "0")}-01`
//                           : `${birthYear}-01-01`;
//                         onChange(val);
//                       }
//                     }}
//                     classNames={{
//                       trigger: `text-left w-full border rounded-[8px] border-primary-300 bg-white hover:!border-primary hover:!bg-white focus:!border-primary focus:bg-white`,
...
//                       if (year) {
//                         // Якщо місяць обраний - YYYY-MM-01, інакше YYYY-01-01
//                         const val = birthMonth
//                           ? `${year}-${birthMonth.padStart(2, "0")}-01`
//                           : `${year}-01-01`;
//                         onChange(val);
//                       }
//                     }}
    ...
    if (isBirthDateUnknown) {
      if (birthYear && birthMonth) {
        const monthLabel = months.find(
          (m) => Number(m.key) === Number(birthMonth),
        )?.label;
