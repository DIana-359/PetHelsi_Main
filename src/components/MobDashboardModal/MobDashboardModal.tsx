...
export default function MobDashboardModal() {
  ...
  return (
    <div
      className={`md:hidden fixed top-[68px] right-0 z-50 overflow-y-auto w-full bg-background shadow-lg px-3 py-[32px] xs:px-6 transform transition-transform duration-500 ease-in-out ${
